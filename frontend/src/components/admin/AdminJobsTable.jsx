                                            ...
                                            <Popover>
                                                ...
                                                <PopoverContent className="w-48 p-2">
                                                    <div className="space-y-2">
                                                        ...
                                                        >
                                                            <Button
                                                                className="bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-full shadow-lg hover:scale-105 transition-all"
